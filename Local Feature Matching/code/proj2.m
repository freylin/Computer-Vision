...
% kd-tree:
[matches, confidences] = match_features_kdtree(image1_features, image2_features);

% pca: run get_pca_mat() to get pca valiables, if pca_*.mat exists, continue.
% dim = 64;
% get_pca_mat(scale_factor, feature_width, dim);
% [matches, confidences] = match_features_pca(image1_features, image2_features);
