...
data_path = '../data/'; 
train_path_pos = fullfile(data_path, 'faces'); %Positive training examples. 36x36 head crops
...
load('../data/faces/ImageData.mat');
SubDir_Data = round(SubDir_Data(:, :));
...
for i = 1 : num_images
    ...
    IM = rgb2gray(IM);
    xmin = SubDir_Data(3, i);
    ymin = SubDir_Data(4, i);
    xmax = SubDir_Data(7, i);
    ymax = SubDir_Data(8, i);
